import{a as f}from"./vendor-8cce9181.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function s(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(e){if(e.ep)return;e.ep=!0;const a=s(e);fetch(e.href,a)}})();const o="/project-test/assets/symbol-defs-de218909.svg",n=document.querySelector(".Backdrop");document.querySelector(".Modal");const v=document.querySelector(".ExerciseFiltersListSubcategories"),d=document.querySelector(".ModalClose"),p="IsOpen";let u={},m,g;v.addEventListener("click",y);async function y(t){if(t.target.nodeName!=="BUTTON")return;const i=t.target.closest("li").id;console.log(i);try{u=await h(i),R(),I(u),L(),document.querySelectorAll("span").forEach(function(s){s.textContent=s.textContent.charAt(0).toUpperCase()+s.textContent.slice(1)}),document.addEventListener("keydown",function(s){s.key==="Escape"&&l()}),n.addEventListener("click",function(s){s.target===n&&l()}),d.addEventListener("click",function(s){s.target===d&&l()})}catch{}}async function h(t){const i=`https://energyflow.b.goit.study/api/exercises/${t}`;try{return(await f.get(i)).data}catch{}}function I(t){const i=`<div class="Modal">
  ...
  </div> `;n.innerHTML=i}function R(){n.classList.add(p)}function l(){n.classList.remove(p)}function L(){M(),$()}function M(){m=document.querySelector(".RatingActive"),g=document.querySelector(".NumberRating")}function $(t=g.innerHTML){const i=t/.05;m.style.width=`${i}%`}export{o as i};
//# sourceMappingURL=modal_window-c5af70b1.js.map
