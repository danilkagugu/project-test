import{a as m}from"./vendor-db25513e.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function u(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(e){if(e.ep)return;e.ep=!0;const s=u(e);fetch(e.href,s)}})();const I="/project-test/assets/symbol-defs-940e27cf.svg",a=document.querySelector(".Backdrop"),l=document.querySelector(".Modal"),f=document.querySelector(".SearchButton");document.querySelector(".ModalClose");const c=document.querySelector(".AddRemoveFavorites"),d="IsOpen";let n={};f.addEventListener("click",p);async function p(){try{n=await g(),h(),y(n),c.addEventListener("submit",v),l.addEventListener("click",L)}catch{}}async function g(){const t="https://energyflow.b.goit.study/api/exercises/64f389465ae26083f39b17a4";try{return(await m.get(t)).data}catch{}}function y(t){l.innerHTML=` <button class="ModalClose" type="button">
  ...
  </div>  `}function v(){c.innerText="Remove from"}function h(){a.classList.add(d)}function L(){a.classList.remove(d)}export{I as i};
//# sourceMappingURL=modal_window-48f78ea4.js.map
